...
public class HITSERVICECALL implements java.io.Serializable {
	...
	@com.fasterxml.jackson.annotation.JsonProperty("HIT_EDIT_CODE")
	private String HIT_EDIT_CODE;
	@com.fasterxml.jackson.annotation.JsonProperty("HIT_EDIT_RESULT")
	...
	public HITSERVICECALL(java.lang.String HIT_EDIT_CODE,
			java.lang.String HIT_EDIT_RESULT) {
		this.HIT_EDIT_CODE = HIT_EDIT_CODE;
		this.HIT_EDIT_RESULT = HIT_EDIT_RESULT;
	}
}
